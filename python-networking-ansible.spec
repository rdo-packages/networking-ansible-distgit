...
%changelog
* Thu Feb 21 2019 dradez@redhat.com - 1.0.6-1
- Update to 1.0.6 version

* Tue Dec 04 2018 dradez@redhat.com - 1.0.5-1
- Update to 1.0.5 version

* Wed Oct 03 2018 libosvar@redhat.com - 1.0.4-1
- Update to 1.0.4 version

* Tue Aug 21 2018 RDO <dev@lists.rdoproject.org> 1.0.1-1
- Update to 1.0.1

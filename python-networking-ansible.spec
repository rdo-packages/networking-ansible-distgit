...
%global excluded_brs doc8 bandit pre-commit hacking flake8-import-order flake8
...
# Project's upstream tests are no longer passing CI
# so check phase is disabled
#%check
...
%changelog
* Wed Sep 21 2022 RDO <dev@lists.rdoproject.org> 5.0.0-1
- Update to 5.0.0
